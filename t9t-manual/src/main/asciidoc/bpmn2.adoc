...
== Process End Events
All end events can also execute a regular workflow step. The step name to use is defined using an extension `camunda:properties` with the name `WorkflowStepName` attached to the triggered end event in process definition.
