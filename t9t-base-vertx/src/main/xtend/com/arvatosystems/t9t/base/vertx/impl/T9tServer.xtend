...
class T9tServer extends AbstractVerticle {
    ...
    private static int     tcpPort  = 8023           // default for TCP/IP
    private static String  cfgFile  = null;
    private static String  filePath = null;
    private static String  corsParm = "*";
    private final IMessageCoderFactory<BonaPortable, ServiceResponse, byte[]> coderFactory = new MultiThreadMessageCoderFactory2(BonaPortable, ServiceResponse)
